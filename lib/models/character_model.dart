...
class CharacterModel {
    ...
    factory CharacterModel.fromJson(Map<String, dynamic> json) => CharacterModel(
        ...
        appearance: json["appearance"] == null ? null : List<int>.from(json["appearance"].map((x) => x)),
        portrayed: json["portrayed"] == null ? null : json["portrayed"],
        category: json["category"] == null ? null : json["category"],
        betterCallSaulAppearance: json["better_call_saul_appearance"] == null ? null : List<dynamic>.from(json["better_call_saul_appearance"].map((x) => x)),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "better_call_saul_appearance": betterCallSaulAppearance == null ? null : List<dynamic>.from(betterCallSaulAppearance!.map((x) => x)),
    };
}
